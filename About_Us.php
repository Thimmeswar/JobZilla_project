...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>TalentTap Solutions | About Us 1</title>
...
<body>
	...
	<div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="section-full p-t120 p-b90 site-bg-white twm-about-1-area" style="margin-top: -30px;">
                ...
                <div class="container">
                    ...
                    <div class="twm-about-1-bottom-wrap" style="margin-top: -30px;">
                        <div class="row">
            ...
            <div class="section-full p-t120 p-b90 site-bg-light twm-how-t-get-wrap7">
                ...
                <div class="container">
                    ...
                    <div class="twm-how-t-get-section" style="margin-top: -100px; margin-bottom: -70px;">
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <div class="twm-how-t-get-section-left">
                                    ...
                                    <div class="twm-how-t-get-bottom">
                                        <a href="About_Us.php" class="site-button">Edit Profile</a>
            ...
            <div class="section-full p-t120 p-b90 site-bg-white twm-how-it-work-area2" style="margin-bottom: -40px;">
            ...
            <div class="section-full p-t120  site-bg-white twm-companies-wrap">
                ...
                <!-- TITLE START-->
                <div class="section-head center wt-small-separator-outer" style="margin-top: -80px;">
                    <div class="wt-small-separator site-text-primary">
...
<!--    <div class="switcher-btn-bx">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="about-1a39b.php?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="about-161e7.php?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="about-1cce5.php?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="about-113f7.php?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="about-119a6.php?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="about-1fe5c.php?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="about-1ab47.php?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="about-15f8d.php?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="about-15663.php?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="about-128ac.php?theme=css/skin/skin-10"></a></li>
