...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>TalentTap Solutions | Blog</title>
...
<body>
	...
	<div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="section-full p-t120  p-b90 site-bg-white" style="margin-top: -40px;">
                ...
                <div class="section-head center wt-small-separator-outer">
                        ...
                        <h2 class="wt-title">Latest Blogs</h2>
                    ...
                    <div class="masonry-wrap row d-flex">
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg1.jpg" alt=""></a>
                                </div>                                    
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg2.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                                    ...
                                    <div class="wt-post-title ">
                                        <h4 class="post-title">
                                            <a href="Blog-Details.php">5 things to know about the March
                                                2023 jobs report</a>
                                        </h4>
                                    </div>
                                    <div class="wt-post-text ">
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg3.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                                    ...
                                    <div class="wt-post-title ">
                                        <h4 class="post-title">
                                            <a href="Blog-Details.php">Job Board is the most important 
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg4.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg5.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg6.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg7.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg8.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
                        ...
                        <div class="masonry-item col-lg-4 col-md-12">
                            ...
                            <div class="blog-post twm-blog-post-1-outer">
                                <div class="wt-post-media">
                                    <a href="Blog-Details.php"><img src="images/blog/latest/bg9.jpg" alt=""></a>
                                </div>                                    
                                <div class="wt-post-info">
                                    <div class="wt-post-meta ">
                                        <ul>
        ...
        <!-- CONTENT END -->
           ...
           <div class="section-full p-t120 p-b90 twm-how-it-work-area" style="background-image: url(images/home-7/hiw-bg.jpg); margin-top: -20px;">
                        
               <div class="container" style="margin-bottom: -40px;">
        
                            <!-- TITLE START-->
                            <div class="section-head center wt-small-separator-outer  content-white" style="margin-top: -40px;">
        ...
        <!-- EXPLORE NEW LIFE START -->
            ...
            <!-- EXPLORE NEW LIFE END -->
              ...
              <?php include 'Testimonials_2.php';?>
...
<!--    <div class="switcher-btn-bx">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="bloga39b.php?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="blog61e7.php?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="blogcce5.php?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="blog13f7.php?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="blog19a6.php?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="blogfe5c.php?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="blogab47.php?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="blog5f8d.php?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="blog5663.php?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="blog28ac.php?theme=css/skin/skin-10"></a></li>
