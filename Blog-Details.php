...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>TalentTap Solutions | Blog Single</title>
...
<!--                                    <div class="widget all_services_list">
                                        ...
                                        <div class="all_services m-b30">
                                            <ul>
                                                <li><a href="job-detail.php">Categories</a> <span class="badge">08</span></li>
                                                <li><a href="job-detail.php">Education</a> <span class="badge">12</span></li>
                                                <li><a href="job-detail.php">Information</a><span class="badge">15</span></li>
                                                <li><a href="job-detail.php">Jobs</a><span class="badge">25</span></li>
                                                <li><a href="job-detail.php">Learn</a><span class="badge">36</span></li>
                                                <li><a href="job-detail.php">Skill</a><span class="badge">12</span></li>
                                            </ul>
                                        </div>
                                    </div>-->
                                                    ...
                                                    <div class="wt-post-info">
                                                        <div class="wt-post-header">
                                                            ...
                                                            <span class="post-title"> 
                                                                <a href="blog">Equipment you can count on. People you can trust.</a>
                                                            </span>
                                                        </div>                                                    
                                                    </div>
                                                </div>
                                                ...
                                                <div class="widget-post clearfix">
                                                    ...
                                                    <div class="wt-post-info">
                                                        <div class="wt-post-header">
                                                            ...
                                                            <span class="post-title">
                                                                <a href="blog">Advanced Service Functions by Air Transport</a>
                                                            </span>
                                                        </div>                                                    
                                                    </div>
                                                </div>
                                                ...
                                                <div class="widget-post clearfix">
                                                    ...
                                                    <div class="wt-post-info">
                                                        <div class="wt-post-header">
                                                            ...
                                                            <span class="post-title">
                                                                <a href="blog">Proper arrangement for keeping the goods in the warehouse</a>
                                                            </span>
                                                        </div>                                                    
                                                    </div>
                                                </div>
...
<!--                                    <div class="widget tw-sidebar-tags-wrap">
                                        ...
                                        <div class="tagcloud">
                                            <a href="job-list.php">General</a>
                                            <a href="job-list.php">Jobs </a>
                                            <a href="job-list.php">Payment</a>                                            
                                            <a href="job-list.php">Application </a>
                                            <a href="job-list.php">Work</a>
                                            <a href="job-list.php">Recruiting</a>
                                            <a href="job-list.php">Employer</a>
                                            <a href="job-list.php">Income</a>
                                            <a href="job-list.php">Tips</a>
                                        </div>
                                    </div>-->
