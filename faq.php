...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>TalentTap Solutions | FAQ</title>
	...
	<div class="page-wraper">
       ...
       <?php include 'header.php';?>
        ...
        <div class="page-content">
            ...
            <div class="section-full p-t120  p-b90 site-bg-white" style="margin-top: -40px;">
                  <div class="section-head center wt-small-separator-outer">
                        <div class="wt-small-separator site-text-primary">
                           <div>User Guide & FAQs</div>                                
                        </div>
                        <h2 class="wt-title">Quick Answers to Common Questions</h2>
            ...
            <div class="section-full p-t120 p-b90 site-bg-gray twm-how-t-get-wrap7" style="margin-bottom: 40px;">
...
<!--    <div class="switcher-btn-bx">
    ...
    <div class="styleswitcher-inner">
        ...
        <ul class="color-skins">
            <li><a class="theme-skin skin-1" href="faqa39b.php?theme=css/skin/skin-1"></a></li>
            <li><a class="theme-skin skin-2" href="faq61e7.php?theme=css/skin/skin-2"></a></li>
            <li><a class="theme-skin skin-3" href="faqcce5.php?theme=css/skin/skin-3"></a></li>
            <li><a class="theme-skin skin-4" href="faq13f7.php?theme=css/skin/skin-4"></a></li>
            <li><a class="theme-skin skin-5" href="faq19a6.php?theme=css/skin/skin-5"></a></li>
            <li><a class="theme-skin skin-6" href="faqfe5c.php?theme=css/skin/skin-6"></a></li>
            <li><a class="theme-skin skin-7" href="faqab47.php?theme=css/skin/skin-7"></a></li>
            <li><a class="theme-skin skin-8" href="faq5f8d.php?theme=css/skin/skin-8"></a></li>
            <li><a class="theme-skin skin-9" href="faq5663.php?theme=css/skin/skin-9"></a></li>
            <li><a class="theme-skin skin-10" href="faq28ac.php?theme=css/skin/skin-10"></a></li>
