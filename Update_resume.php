<div class="section-full p-t120 p-b120 twm-explore-area bg-cover " style="background-image: url(images/background/bg-1.jpg); margin-top: 40px; margin-bottom: 40px;">
                <div class="container">

                    <div class="section-content" style="margin-top: -90px; margin-bottom: -50px;">
                        <div class="row">
